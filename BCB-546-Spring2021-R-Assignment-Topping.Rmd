...
Then, load any R packages needed for this assignment. Tidyverse is the only package needed. Use `install.packages("tidyverse")`
...
``` {r}
Maize_Chromosomes_Ascending <- Maize_Chromosomes[order(as.numeric(Maize_Chromosomes$Position)), ]
Teosinte_Chromosomes_Ascending <- Teosinte_Chromosomes[order(as.numeric(Teosinte_Chromosomes$Position)), ]
Maize_Chromosomes_Descending <- Maize_Chromosomes[order(as.numeric(Maize_Chromosomes$Position, decreasing = T)), ]
Teosinte_Chromosomes_Descending <- Teosinte_Chromosomes[order(as.numeric(Teosinte_Chromosomes$Position, decreasing = T)), ]
```
